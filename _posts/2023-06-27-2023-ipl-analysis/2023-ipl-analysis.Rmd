...
Code and data for the project is available [here](https://github.com/wickistats/WickiStats/blob/main/data/AdjStatsMaker.R), and feel free to direct any suggestions and questions to wickistats@gmail.com. 