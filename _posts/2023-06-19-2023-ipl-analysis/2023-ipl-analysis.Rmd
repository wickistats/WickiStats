...
So what's the alternative? I'm presenting Adjusted Run Rate and Adjusted Average as new methods to gauge how much players helped or hurt their team. The metrics were inspired by [this ESPNcricinfo article](https://www.espncricinfo.com/story/ipl-2020-how-many-wins-do-the-top-players-contribute-to-their-team-in-an-ipl-season-1236781) which presented their own Runs Above Average metric that has unfortunately not been updated or expanded upon since 2020. I present what I believe is an improvement on their metric with my Adjusted Run Rate and introduce a way of evaluating the effect of preserving or taking wickets with the Adjusted Average metric. This is done by evaluating a player's strike rate/economy and average in relation to the overs they bat/bowl in, the venue they are playing at, and the opposition they face. 
...
Code and data for the project is available [here](https://github.com/wickistats/WickiStats/blob/main/data/AdjStatsMaker.R). Additionally, feel free to direct any suggestions and questions to wickistats@gmail.com. 